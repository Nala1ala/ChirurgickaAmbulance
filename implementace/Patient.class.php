...
class Patient {
    ...
    // Attribute getters
    public function getBirthCertificateNumber(): ?int { return $this->birthCertificateNumber; }
    public function getGivenName(): string { return $this->givenName; }
    public function getSurname(): string { return $this->surname; }
    public function getAddress(): string { return $this->address; }
    public function getInsuranceCompanyNumber(): int { return $this->insuranceCompanyNumber; }
    public function getPhoneNumber(): string { return $this->phoneNumber; }
    public function getBirthdate(): string { return $this->birthdate; }

    public function getDiagnoses(): array { return $this->diagnoses; }
    public function getPrescriptions(): array { return $this->prescriptions; }
    public function getCertificates(): array { return $this->certificates; }

    // Attribute setters
    public function setAddress(string $address): void { $this->address = $address; }
    public function setPhoneNumber(string $phoneNumber): void { $this->phoneNumber = $phoneNumber; }
    public function setInsuranceCompanyNumber(int $insuranceCompanyNumber): void { $this->insuranceCompanyNumber = $insuranceCompanyNumber; }
    public function setGivenName(string $givenName): void { $this->givenName = $givenName; }
    public function setSurname(string $surname): void { $this->surname = $surname; }

    public function setDiagnoses(array $diagnoses): void { $this->diagnoses = $diagnoses; }
    public function setPrescriptions(array $prescriptions): void { $this->prescriptions = $prescriptions; }
    public function setCertificates(array $certificates): void { $this->certificates = $certificates; }
}
